...
// --- Sub-components (Reactions, Pickers, Messages) ---
// ... (Kode untuk ReactionPicker, Reactions, NewsMessage, UserMessage, SystemMessage, AnnouncementMessage tetap sama seperti sebelumnya) ...
